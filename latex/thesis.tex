...
\section{Turns}
	...
	\begin{figure}[H]
		...
		\begin{subfigure}{.48\textwidth}
			...
			\caption{Combining the chambers. The red dashed line represents the turn axis.}
		\end{subfigure}
		\phantom{aa}
		\begin{subfigure}{.48\textwidth}
			\includegraphics[width=\textwidth]{../tec/turn/11.png}
			\caption{Intersecting the combined surface with planes that are supersets of the turn axis.}
		\end{subfigure}
