...
\chapter{Introduction}
	...
	\section{State of the Art}
		Conventional CAD systems are modelers that allow their user to create free-form curves and surfaces using interactive control points that can be moved to any location on a three-dimensional canvas. Moreover, these systems usually also allow the generation of common geometries (for instance cylinders or cuboids) using a set of input parameters, which is an important feature in most mechanical engineering applications. Given these tools, such CAD systems give the user an unlimited amount of strategies for creating a three-dimensional model of a mechanical part fit for their use \cite{Camba2016}.
